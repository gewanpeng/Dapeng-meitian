...
@implementation DapengZuoZheTableViewCell
{
...
//        NSLog(@"%@",productList);
    ...
    for (NSInteger i=0; i<RColCount; i++) {
        ...
        UILabel * namelib = [[UILabel alloc]initWithFrame:CGRectMake(10, CGRectGetMaxY(imageView.frame)+10, btn.frame.size.width-20, 30)];
        ...
        UILabel * fenlei = [[UILabel alloc]initWithFrame:CGRectMake(20, CGRectGetMaxY(title.frame)+5, btn.frame.size.width-20, 30)];
...
- (void)buttonTapped:(DapengButton *)btn
{
    ...
    [_delegate productZuoCell:self actionWithFlag:ss andArray:arr];}
